...
##########################################################################################################################################################################
############################## htseq sbatch script froma sample sheet #############################################################################
...
# htseq is an alternative to kallisto in the main pipeline
...
mkdir ${analysis_out_dir}/htseq

cp sample_sheet_fc.csv ${analysis_out_dir}/sample_sheet_htseq_${RUNID}.csv
INPUT=${analysis_out_dir}/sample_sheet_htseq_${RUNID}.csv
